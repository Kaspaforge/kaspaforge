...
const T = RU ? {
  ...
  consent: 'На сервер уйдёт дополнительная зашифрованная копия рабочего профиля. Устройства с этим профилем получат Wallet, Safe hot/funding keys, Escrow, Market и Chats. Alarm, heir и arbiter keys автоматически исключаются и остаются только на устройстве, где хранятся.\n\nForge Sync не заменяет офлайн-файл .age.',
  ...
  consent: 'An additional encrypted copy of your working profile will be stored on the server. Devices holding this profile receive Wallet, Safe hot/funding keys, Escrow, Market and Chats. Alarm, heir and arbiter keys are excluded automatically and stay only on the device that holds them.\n\nForge Sync does not replace your offline .age file.',

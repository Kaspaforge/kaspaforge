/* Kaspa Safe support widget — Sara. Self-contained chat bubble that talks to /api/support/
   (nginx routes it to the officeforge-support-safe instance; canon = KASPA-SAFE-FAQ.md).
   Port of the officeforge.co widget, reskinned to the Safe palette + EN/RU via <html lang>.
...
(function () {
  ...
  if (window.__ksafeSara) return; window.__ksafeSara = true;
  var API = '/api/support';
  ...
  var T = RU ? {
    btn: 'Спросить Сару',
    sub: 'Поддержка Kaspa Safe',
    hello: 'Привет! Я Сара, поддержка Kaspa Safe 🙂 Спрашивай про сейф: создание, выводы, отмена кражи, наследование, восстановление. Приватные ключи я никогда не спрашиваю — и ты их никому не показывай.',
    ph: 'Вопрос про Kaspa Safe…',
    send: 'Отправить',
    ...
    btn: 'Ask Sara',
    sub: 'Kaspa Safe support',
    hello: "Hi! I'm Sara, Kaspa Safe support 🙂 Ask me anything about the vault — creating one, withdrawals, cancelling a theft, inheritance, recovery. I'll never ask for your private keys — don't show them to anyone.",
    ph: 'Ask about Kaspa Safe…',
    send: 'Send',
